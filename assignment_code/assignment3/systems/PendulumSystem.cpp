...
std::vector<glm::vec3> PendulumSystem::ComputeVelocity(const ParticleState& state) const {
...
std::vector<glm::vec3> PendulumSystem::ComputeAcceleration(const ParticleState& state) const {
    ...
    for (size_t i = 0; i < particles_.size(); i++) {
        ...
        // Compute drag force
        glm::vec3 drag_force = -ScenePhysicsNode::b * velocity;
